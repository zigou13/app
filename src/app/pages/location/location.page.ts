...
export class LocationPage implements OnInit {
  ...
  async search() {
    console.log(localStorage.getItem('ubic1') ,localStorage.getItem('zip1') , localStorage.getItem('uid'));
   this.service.userlocation( localStorage.getItem('ubic1') ,localStorage.getItem('zip1') , localStorage.getItem('uid'));
